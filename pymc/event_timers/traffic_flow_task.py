...
class TrafficFlowTask(ConnectionTimerEvent):
...
def test():
    ...
    ConnectionTimerExecutor.getInstance().queue(interval=flow_task._recalc_interval_ms, task=flow_task, repeat=True, test_mode=True)
